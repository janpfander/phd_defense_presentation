...
# A cognitive perspective on trust in science {style="text-align: center;"}
...
Hugo Mercier & Kevin Arceneaux 

<br>

<span style="font-size: 70%;">September 3, 2025</span>


::: {.absolute bottom="-200px" left="24%"}
![](images/institut_jean_nicod.png){height="80px"}
:::

::: {.absolute bottom="-200px" right="24%"}
![](images/ens.png){height="80px"}
:::
...
Cognitive mechanisms to explain trust in science

<br>

Predictions of these mechanisms
...
::: {.fragment}
- or due to people feeling **alienated** from modern and increasingly complex institutions. <span style="font-size: 50%;">[@gauchatCulturalAuthorityScience2011]</span> 
:::
...
The literature focuses mostly on why people do not trust science.

. . .

Elevated public trust in science is considered the rational default state. 

---

## {.big-center}

Only the "knowledge deficit" view (implicitly) offers an explanation. 

. . .

It suggests that if trust in science is rational, it should be caused mostly by knowledge and understanding of science.
...
:::{.notes}
default state--it's the deviations that require an explanation
:::
...
"60% of U.S. adults could correctly note that a control group can be useful in making sense of study results." <span style="font-size: 50%;">[@nationalscienceboardnationalsciencefoundationScienceTechnologyPublic2024, p.24]</span> 
...
*For example, if a colleague at work fixes our computer, we might remember that they are competent, but not exactly how they fixed it.*
:::
...
::: {.notes}
But: rare knowledge is only impressive if true...
...
::: {.absolute right="-10%" bottom="-10%" style="font-size:1em; z-index:9999; width:300px; white-space:normal;"}
...
Participants perceived the impressive texts as more impressive. 
...
::: {.big-center}
In simulations, we show that this inference--from agreement to both accuracy and competence--is, in fact, rational. 
:::
...
The most important assumption underlying these simulations was that informants are not systematically biased, i.e. all of them share a tendency to be wrong.
:::
...
::: {.big-center}
Participants behaved as what was predicted to be rational by our simulations: 
...
To which extent do these people reject scientific knowledge?
...
:::{.fragment}
"In general, would you say that you trust science a lot, some, not much, or not at all?"<span style="font-size: 50%;">[@wellcomeglobalmonitorWellcomeGlobalMonitor2018]</span>
:::
:::
...
::: {.fragment .fade-out}
<div style="position:absolute; top:23%; left:10%; width:75%; height:63%; background:white;"></div>
:::
...
There is a relationship between knowledge and trust. But: 

- Even the lowest decile in science knowledge, which on average answered correctly only on 20 % of the questions, had an average acceptance rate of 91.7 %.
...
:::{.notes}
This suggests in many instances, science rejection might have nothing to do with how people evaluate the underlying science.

Instead, other factors (e.g. political ideology) motivate people to reject specific science beliefs. 
:::
...
:::{.notes}
Something that is sometimes overseen: people don't seem to trust news a whole lot - which is problematic given that most news are true
:::
...
When exposed to science, people rationally develop a positive impression of science–in particular of the competence of scientists--by
...
- and by inferring accuracy from consensus.
...
This account can make sense of two facts that appear conflicting:

. . .

1. Science knowledge is only a weak predictor of trust in science. <span style="font-size: 50%;">[@allumScienceKnowledgeAttitudes2008]</span>

. . .

2. Education--in particular science education--is the strongest predictor of trust in science. <span style="font-size: 50%;">[@noyScienceGoodEffects2019; @wellcomeglobalmonitorWellcomeGlobalMonitor2018]</span>

---

## {.big-center}

According to the rational impression account, education mostly works by fostering (rational) impressions. 

. . .

This does not require building a profound understanding of science, or a long-term memory of certain science facts.
...
::: {.fragment fragment-index=2}
or because it is rejected by other authorities–political, religious–which people trust.
:::
...
For example, people value open-science practices. <span style="font-size: 50%;">[@songTrustingShouldersOpen2022]</span>

. . .

These practices lead to more robust and consensual scientific findings.
...
![](images/consensus_simulations.png){width="100%"}

---

![](images/consensus_stimulus-exp4.png){width="100%"}
...
![](images/forest-automated.png){width="70%"}

:::{.notes}
The Garret study has been a longitudinal study and therefor provides many, many effect sizes. 
:::
...
There might be a bias in the selection of news items that researchers use.

People might appear more skeptical in misinformation studies than would be in the real world. 
...
:::{.notes}
It is important to keep in mind that these are only 3 of more than 60 papers, all in the US. If they don't suffer from researcher selection bias of news items, they are not representative in many other ways...
:::
...
![[@acerbiResearchNoteFighting2022]](images/exposure_misinformation.png){fig-align="center" width="100%"}

---

![[@newmanReutersInstituteDigital2024]](images/reuters_interest_2024.png){fig-align="center" width="100%"}

:::{.notes}
In 2017, 63% of people said they were very or extremely interested in the news.

In 2024, this number was down to 46%.
:::
